...
const Jobs = () => {
  return (
    <>
      <div class="nav-down" style={{borderRadius:"20px", marginLeft: "2rem",marginRight:"2rem"}} >
        <div><p style={{ color: "white", marginTop: "3rem" }}>Freelancer . Jobs
        </p>
        </div>
        <h1 style={{ color: "white", marginBottom: "1rem" ,marginLeft:"500px" }}>
          Browse by Category
        </h1>
        <input type="search" className="category_search" placeholder="Search for a category" color="white" style={{ border: "none", width: "80%", height: "2.5rem", borderRadius: "4px",marginLeft:"90px" }} />
        <button class="btn btn-outline-success" type="submit" color='white' style={{height:"2.7rem"}}>Search</button>
      </div>
      <div className="box" style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-evenly", marginLeft: "2rem", marginRight: "2rem", color: "white",backgroundImage: "linear-gradient( to bottom , #012a4a,#080402 ",paddingTop:"20px",borderRadius:"20px" }}>
        <div className="box1" style={{ color: "white", width: "30%", height: "6.5rem", display: "flex", flexDirection: "row" }}>
          
          < img src="./general.jpg" alt="icon" style={{height:"80px",width:"80px",marginLeft:"50px"}} />
        ...
        < img src="./web.png" alt="icon" style={{height:"80px",width:"80px",marginLeft:"50px"}} />
        ...
        < img src="./app.png" alt="icon" style={{height:"80px",width:"80px",marginLeft:"50px"}} />
        ...
        < img src="./cyber.jpg" alt="icon" style={{height:"80px",width:"80px",marginLeft:"50px"}} />
        ...
        < img src="./iot.jpg" alt="icon" style={{height:"80px",width:"80px",marginLeft:"50px"}} />
