    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <img src="log1.png" style={{ width: "15vh", paddingRight: "5vh" }} />
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            ...
            <Button
              ...
              sx={{ my: 2, color: 'white', display: 'block' }}
            >
              <Link href="/sidebar" style={{ color: "white", textDecoration: "none" }}>My Portfolios</Link>
            </Button>
            <Button
              onClick={handleCloseNavMenu}
              sx={{ my: 2, color: 'white', display: 'block' }}
            >
              <Link href="/about" style={{ color: "white", textDecoration: "none" }}>Chat</Link>
            </Button>
            <Button
              onClick={handleCloseNavMenu}
              sx={{ my: 2, color: 'white', display: 'block' }}
            >
              <Link href="/createport" style={{ color: "white", textDecoration: "none" }}>Build your Site</Link>
            </Button>
          </Box>
          <Box sx={{ flexGrow: 0 }}>
